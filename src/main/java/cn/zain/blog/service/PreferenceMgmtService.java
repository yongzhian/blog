...
import cn.zain.blog.util.TimeZones;
...
public class PreferenceMgmtService {
    ...
    public void loadSkins(final JSONObject preference) throws Exception {
        ...
        final String currentSkinDirName = preference.optString(Skin.SKIN_DIR_NAME);
        ...
        if (!skinDirNames.contains(currentSkinDirName)) {
            ...
            preference.put(Skin.SKIN_DIR_NAME, Option.DefaultPreference.DEFAULT_SKIN_DIR_NAME);
            preference.put(Skin.SKIN_NAME, Latkes.getSkinName(Option.DefaultPreference.DEFAULT_SKIN_DIR_NAME));
        ...
        if (!skinsString.equals(preference.getString(Skin.SKINS))) {
            LOGGER.debug("The skins directory has been changed, persists the change into preference");
            preference.put(Skin.SKINS, skinsString);
            updatePreference(preference);
        }

        Skins.setDirectoryForTemplateLoading(preference.getString(Skin.SKIN_DIR_NAME));
