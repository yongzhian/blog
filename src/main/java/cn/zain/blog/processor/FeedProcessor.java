...
import cn.zain.blog.model.feed.atom.Category;
import cn.zain.blog.model.feed.atom.Entry;
import cn.zain.blog.model.feed.atom.Feed;
import cn.zain.blog.model.feed.rss.Channel;
import cn.zain.blog.model.feed.rss.Item;
    ...
    public void blogArticlesRSS(final HTTPRequestContext context) {
        ...
        try {
            ...
            for (int i = 0; i < articles.length(); i++) {
                ...
                for (int j = 0; j < tagStrings.length; j++) {
                    final cn.zain.blog.model.feed.rss.Category catetory = new cn.zain.blog.model.feed.rss.Category();
