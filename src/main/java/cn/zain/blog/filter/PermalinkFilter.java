...
import cn.zain.blog.processor.ArticleProcessor;
import cn.zain.blog.processor.PageProcessor;
...
import cn.zain.blog.service.ArticleQueryService;
import cn.zain.blog.service.PermalinkQueryService;
 ...
 * @since 0.3.1
 * @see ArticleProcessor#showArticle(org.b3log.latke.servlet.HTTPRequestContext,
 * javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse) 
 * @see PageProcessor#showPage(org.b3log.latke.servlet.HTTPRequestContext)
 */
public final class PermalinkFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain)
        ...
        LOGGER.log(Level.INFO, "Request URI[{0}]", requestURI);
